                ...
                <form action="#" class="wizard-vertical">
                    ...
                    <fieldset class="pt-0">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="kedatangan-no">No Kedatangan</label>
                                    <input type="text" class="form-control" id="kedatangan-no">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="kedatangan-date">Tanggal kedatangan</label>
                                    <fieldset class="form-group position-relative has-icon-left">
                                        <input type="text" class="form-control pickadate" id="kedatangan-date">
                                        <div class="form-control-position">
                                            <i class='bx bx-calendar'></i>
                                        </div>
                                    </fieldset>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="kedatangan-batch">Batch</label>
                                    <input type="text" class="touchspin" value="1" id="kedatangan-batch">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group" id="kedatangan-body">
                                    {{-- <label for="kedatangan-item">Nama</label>
                                    <select class="select2 form-control" id="kedatangan-item">
                                        <option value=""></option>
                                    </select> --}}
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <label for="kedatangan-jumlah">Jumlah</label>
                                    <input type="text" class="touchspin" value="1" data-bts-postfix="pcs" id="kedatangan-jumlah">
                                </div>
                            </div>
                            <div class="col-lg-1">
                                <div class="form-group">
                                    <button disabled type="button" id="kedatangan-tambah" class="btn btn-icon btn-outline-primary mr-1 mt-2"><i class="bx bx-plus"></i></button>
                                </div>
                            </div>
                            <div class="col-12 pr-0">
                                <div class="table-responsive" id="kedatangan-list">
                                    <table class="table p-0">
                                        <thead>
                                            <tr>
                                                <th>No</th>
