                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                        ...
                        <ul class="nav navbar-nav bookmark-icons">
                            <li class="nav-item d-none d-sm-block"><a class="nav-link"><h5 class="text-muted mb-0">@yield('page', '')</h5></a></li>
                        </ul>
                    </div>
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <div class="user-nav d-sm-flex d-none"><span class="user-name">{{Auth::user()->firstname.' '.Auth::user()->lastname}}</span><span class="user-status text-muted">{{Auth::user()->role}}</span></div><span><img class="round" src="{{ URL::asset('app-assets/images/portrait/small/avatar-s-11.jpg') }}" alt="avatar" height="40" width="40"></span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right pb-0">
                                <a class="dropdown-item" href="{{ url('/'.Auth::user()->role.'/profile') }}"><i class="bx bx-user mr-50"></i> Edit Profile</a>
